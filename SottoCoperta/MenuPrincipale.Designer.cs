namespace SottoCoperta
{
	partial class MenuPrincipale
	{
		...
		private void InitializeComponent()
		{
			...
			this.button_archivia = new System.Windows.Forms.Button();
			...
			this.label1.Text = "Benvenuti in SottoCoperta";
			// 
			// button_recupera
			// 
			...
			// button_archivia
			// 
			this.button_archivia.Location = new System.Drawing.Point(58, 137);
			this.button_archivia.Name = "button_archivia";
			this.button_archivia.Size = new System.Drawing.Size(119, 24);
			this.button_archivia.TabIndex = 2;
			this.button_archivia.Text = "Archivia un file";
			// 
			// button_nascondi
			// 
			...
			this.Controls.Add(this.button_archivia);
		...
		private System.Windows.Forms.Button button_archivia;
